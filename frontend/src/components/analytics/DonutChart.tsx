	...
	return (
		<div className="flex items-center gap-6">
			<svg width="112" height="112" viewBox="0 0 112 112">
				<circle cx={cx} cy={cy} r={r} fill="none" stroke="#e4e6ed" strokeWidth="14" />
				<circle
					cx={cx} cy={cy} r={r}
					fill="none"
					stroke="#6c63ff"
					...
					strokeLinecap="round"
				/>
				<text x={cx} y={cy - 6} textAnchor="middle" fontSize="15" fontWeight="bold" fill="#1a1d2e">
					{value}%
				</text>
				<text x={cx} y={cy + 10} textAnchor="middle" fontSize="10" fill="#9399ae">
					{centerLabel}
				</text>
			</svg>
